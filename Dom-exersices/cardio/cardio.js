...
console.log(ulEl)
ulEl.insertAdjacentHTML("beforebegin", myHTML)
...
let cardsHTML = generatePlayerCard('dia ', 20, 40)
cardsHTML += generatePlayerCard('sdsd', 20, 40)
cardsHTML += generatePlayerCard('dsds ', 20, 40)
